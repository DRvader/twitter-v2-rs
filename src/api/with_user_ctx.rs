  ...
  A: Authorization,
{
  ...
  pub fn get_tweet_timeline(&self) -> GetTimelineRequestBuilder<A, Vec<Tweet>, TweetsMeta> {
    self.client.get_user_timeline(self.user_id)
  }
  pub fn get_my_timeline(&self) -> GetTimelineRequestBuilder<A, Vec<Tweet>, TweetsMeta> {
    self.client.get_user_timeline(self.user_id)
  }
